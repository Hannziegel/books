...
function normalizeZone (input, defaultZone) {
  if (isUndefined(input) || input === null) {
    ...
    else if (lowered === 'utc' || lowered === 'gmt') { return FixedOffsetZone.utcInstance } else { return FixedOffsetZone.parseSpecifier(lowered) || IANAZone.create(input) }
...
class DateTime {
  ...
  static fromObject (obj, opts = {}) {
    ...
    if (normalized.weekday && containsGregor && obj.weekday !== inst.weekday) {
      return DateTime.invalid(
        'mismatched weekday',
                `you can't specify both a weekday of ${normalized.weekday
